        ...
        <div className="about-grid">
          <div className="about-text">
            ...
            <p className="animate-in delay-3">
              현재 <span className="highlight">KT Cloud × goorm DEEP DIVE 프론트엔드 과정</span>을 수강하며
              React 기반 개발 역량을 확장 중입니다. 웹 기획·디자인·퍼블리싱·마케팅을 아우르는 폭넓은 경험을
              바탕으로 현업에서 바로 기여할 수 있는 멀티플레이어를 지향합니다.
            </p>
          </div>
            ...
            <div className="stat-cards animate-in delay-2">
              <div className="stat-card">
                <span className="stat-card-num">
                  <CountUp to={17} suffix="년+" />
                </span>
                <span className="stat-card-label">총 실무 경력</span>
              </div>
              <div className="stat-card">
                <span className="stat-card-num">
                  <CountUp to={50} suffix="+" />
                </span>
                <span className="stat-card-label">완료 프로젝트</span>
              </div>
              <div className="stat-card">
                <span className="stat-card-num">
                  <CountUp to={8} suffix="+" />
                </span>
                <span className="stat-card-label">주요 기관</span>
              </div>
              <div className="stat-card">
                <span className="stat-card-num" style={{ fontSize: '1.3rem' }}>React</span>
                <span className="stat-card-label">현재 학습 중</span>
              </div>
            </div>
